            ...
            <Row className='row-wrapper'>
                <Col>
                  <Row className='countdown-wrapper'>
                      ...
                      {!visibleCount && <Col className='countdown-payment'>
              ...
              {!uploadShow ? <Col className='confirm-wrapper'>
              ...
              <Col className='confirm-wrapper1'>
                  <h6 >Konfirmasi Pembayaran <Countdown className="countdown-upload" date={Date.now() + countdownUpload} /></h6>
                  <p 
                  ...
                  variant='success' 
                  className='button-confirm'>Upload</Button>
              </Col>}
            </Row>
        </Container>
    </div>
