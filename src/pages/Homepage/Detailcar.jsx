...
import { Button, Card, Row, CardGroup, Col, Container, CardImg } from 'react-bootstrap'
                ...
                <Col>
                    <Card className='card-car' >
                      ...
                      <Card.Body>
                        ...
                        <Card.Title className='price-car'>Total Rp.{data.price}</Card.Title>
                        <Button
                        className='button-card'
                        variant={isDateSelected ? "success" :"secondary"} 
                        disabled={!isDateSelected} 
                        onClick={handlePayment}>Lanjutkan Pembayaran</Button>
                      </Card.Body>
                    </Card>
                  </Col>
            </Row>
